...
+ (QMUIButton *)generateActionBtnWithBackgroundColor:(UIColor *)color title:(NSString *)title imageName:(NSString *)imageName;
+ (MGSwipeButton *)generateSwipeBtnWithBackgroundColor:(UIColor *)color title:(NSString *)title imageName:(NSString *)imageName;
@end
